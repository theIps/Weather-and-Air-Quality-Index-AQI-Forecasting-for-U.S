...
for year in range(2013, 2018):
    support = spark.read.csv("/home/ldua/Desktop/BigDataProject/support/daily_WIND_" + str(year) + ".csv", header=True)
...
for i in stateval:
    print(i['county_code'])
    df = spark.sql('''select month,year,am_wind from training where county_code=''' + str(
...
predictions.coalesce(1).write.csv('/home/ldua/Desktop/County/Output/predicted_wind', sep=',', header=True)
