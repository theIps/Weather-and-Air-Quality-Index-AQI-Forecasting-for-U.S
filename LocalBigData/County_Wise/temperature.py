...
for i in stateval:
    print(i['county_code'])
    df = spark.sql('''select month,year,am_temp from training where county_code=''' + str(
...
predictions.coalesce(1).write.csv('/home/ldua/Desktop/County/Output/predicted_temp', sep=',', header=True)
