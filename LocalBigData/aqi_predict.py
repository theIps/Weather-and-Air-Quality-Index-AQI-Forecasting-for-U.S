...
inputs = '/home/ldua/Desktop/FinalBig/max_value_combined/max_value_combined.csv'#sys.argv[1]
output = '/home/ldua/Desktop/FinalBig/predicted_aqi/'
...
data.show()
data.coalesce(1).write.csv('/home/ldua/Desktop/FinalBig/predicted_aqi', sep=',', header=True)
#print(aqi.collect())
#training.show(