...
def load_table(words):
   ...
   dict_data['predicted_press'] = float(words[2])
...
for year in range(2013, 2018):
    support = spark.read.csv("support/daily_PRESS_" + str(year) + ".csv", header=True)
...
words.saveToCassandra(keyspace, 'predicted_press')